...
import {
  ...
  Activity, Stethoscope, Edit2, Check, X, Copy, Hash, ArrowRight
} from "lucide-react";
    ...
    <div className="min-h-screen bg-slate-50 font-sans pb-20 selection:bg-violet-100 selection:text-violet-900">
      ...
      <main className="max-w-3xl mx-auto px-6 py-8">
        ...
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.4 }} className="flex flex-col gap-3">
          ...
          {/* SEÇÃO LEGAL */}
          <div className="bg-white border border-slate-200 rounded-2xl overflow-hidden mb-2">
            <Link href="/legal/termos">
              <button className="w-full p-4 flex items-center justify-between text-slate-600 text-sm font-bold hover:bg-slate-50 transition-colors border-b border-slate-100 last:border-0">
            ...
            <Link href="/legal/privacidade">
              <button className="w-full p-4 flex items-center justify-between text-slate-600 text-sm font-bold hover:bg-slate-50 transition-colors">
                <div className="flex items-center gap-3">
                  <Shield size={18} className="text-slate-400" />

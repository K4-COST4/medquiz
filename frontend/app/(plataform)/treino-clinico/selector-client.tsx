...
export default function StandaloneSelectorClient() {
        ...
        <div className="space-y-8">
            ...
            <section>
                ...
                <p className="text-xs text-slate-400 dark:text-slate-500 mb-3">
                    Digite uma patologia e pressione <kbd className="px-1 py-0.5 rounded bg-slate-100 dark:bg-slate-800 text-[10px] font-mono">Enter</kbd> para adicionar.
                </p>
                <div
            ...
            {/* Environment */}
            <section>
                <h2 className="text-sm font-semibold text-slate-700 dark:text-slate-300 mb-3">2. Ambiente do Caso</h2>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                <section>
                    <h2 className="text-sm font-semibold text-slate-700 dark:text-slate-300 mb-3">3. Dificuldade</h2>
                ...
                <section>
                    <h2 className="text-sm font-semibold text-slate-700 dark:text-slate-300 mb-3">4. Nível de Detalhe do Paciente</h2>
                    <div className="space-y-2">
                        {DETAIL_LEVELS.map(d => (
                            <button
                                key={d.value}
